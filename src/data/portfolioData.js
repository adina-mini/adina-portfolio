...
export const projects = [
  ...
  {
    id: 2,
    title: 'QM Logics AI Assistant',
    description: 'Production chat agent for QM Logics\' company site — answers strictly from verified company data with zero-hallucination guardrails, dynamic lead-qualification via AI judgment (not keyword-matching), voice input/output, and a config-driven architecture that can serve a different client by swapping two files.',
    tech: ['FastAPI', 'Groq', 'Deepgram', 'Web Speech API', 'JavaScript'],
    github: null,
    live: null,
    image: '/images/projects/qm-ai-assistant.png',
  },
  {
    id: 3,
    title: 'Multi-Agent System with Evaluation & Observability',
    description: 'Production-style Planner → Researcher → Writer pipeline in LangGraph with LLM-as-Judge scoring, anti-hallucination guardrails, retry logic with exponential backoff, and full LangSmith tracing. 10/10 test cases passing with automated assertions.',
    tech: ['LangGraph', 'Groq', 'Tavily', 'LangSmith', 'Python'],
    github: 'https://github.com/adina-mini/QM-Internship/tree/main/Week_7%2B8_MultiAgent_and%20_evaluation',
    live: null,
    image: '/images/projects/multi-agent-eval.png',
  },
  {
    id: 4,
    title: 'RAG-Powered Technical Audit Analyst',
    description: 'n8n + Pinecone RAG workflow that automates technical audit document analysis, cutting manual review time by 70%.',
  ...
  },
  {
    ...
    github: 'https://github.com/adina-mini/Lead-intake-agent',
    live: null,
  ...
  },
  {
    ...
    github: 'https://github.com/adina-mini/n8n-ai-mail-agent',
    live: null,
  ...
  },
  {
    ...
    live: 'https://adina-mini.github.io/habit_tracker/',
